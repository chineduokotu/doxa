      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-20">
          <div>
            ...
            <h2 className="font-serif text-4xl lg:text-5xl text-stone-900 font-light leading-tight mb-8">
              Built on a belief
              <br />
              <em className="not-italic text-stone-500">in beautiful living.</em>
            </h2>
            <div className="space-y-5 text-stone-600 font-sans text-sm leading-relaxed">
              <p>
        ...
        <div className="py-16 border-t border-stone-200">
          ...
          <h2 className="font-serif text-4xl text-stone-900 font-light text-center mb-12">
            Our Values
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {values.map((v) => (
              <div key={v.title} className="text-center">
                ...
                <h3 className="font-serif text-xl text-stone-900 font-light mb-3">
                  {v.title}
                </h3>
        ...
        <div className="text-center py-16 border-t border-stone-200">
          ...
          <p className="text-stone-500 font-sans text-sm mb-8 max-w-md mx-auto">
